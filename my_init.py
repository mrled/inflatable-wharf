...
# Undo the LD_LIBRARY_PATH set specifically for /sbin/my_init_python.
if 'ORIG_LD_LIBRARY_PATH' in os.environ:
	os.environ['LD_LIBRARY_PATH'] = os.environ['ORIG_LD_LIBRARY_PATH']
	del os.environ['ORIG_LD_LIBRARY_PATH']
